...
{
    const ENABLE_DEFAULT_ADDRESS = 0x01;

    const DISABLE_DEFAULT_ADDRESS = 0x00;
    ...
    {
        return [
            [['member_id', 'name', 'mobile', 'remark', 'province_id', 'province_name', 'city_id', 'city_name', 'district_id', 'district_name', 'detail_address'], 'required'],
    ...
    {
        if ($this->is_default) {
            MemberShippingAddress::updateAll(['is_default' => self::DISABLE_DEFAULT_ADDRESS], [
