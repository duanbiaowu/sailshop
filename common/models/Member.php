...
//            [['password_hash'], 'required', 'on' => ['create']],
    ...
    public function afterValidate()
    {
        ...
        if (isset($userInfo['Member']['status'])) {
            $this->status = $userInfo['Member']['status'];
        }
        if (isset($userInfo['Member']['password_hash'])) {
            if ($passwordHash = trim($userInfo['Member']['password_hash'])) {
    ...
    {
        return $this->hasMany(MemberAccountRecord::className(), ['member_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(MemberShippingAddress::className(), ['member_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(MemberCart::className(), ['member_id' => 'id']);
    }
     ...
     * @return ActiveQuery
     */
    public function getBrowseRecord()
    {
        return $this->hasMany(MemberBrowseRecord::className(), ['member_id' => 'id']);
    }
}
