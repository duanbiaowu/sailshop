...
/**
 * ExpressCompanyController implements the CRUD actions for ExpressCompany model.
 */
class ExpressCompanyController extends Controller
{
    ...
    /**
     * Displays a single ExpressCompany model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ExpressCompany model.
    ...
    /**
     * Updates an existing ExpressCompany model.
    ...
    /**
     * Deletes an existing ExpressCompany model.
    ...
    /**
     * Finds the ExpressCompany model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ExpressCompany the loaded model
