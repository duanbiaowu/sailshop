...
<div class="container">
    <form action="/index.php?con=payment&amp;act=dopay" method="post" target="_blank">
            ...
            <table class="table table-line">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?= $model->formatId() ?>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/index.php?con=ucenter&amp;act=order_detail&amp;id=9" target="_blank" class="red">
                            查看订单
                        </a>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="blank">
            <p class="tc">
                <input class="btn btn-main" type="submit" value="立即支付">
