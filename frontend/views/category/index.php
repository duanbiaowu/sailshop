...
<div class="bread-crumb">
    <ol class="container">
        ...
        <li><a class="category-0" href="index?id=<?= $ancestor->id ?>"><?= $ancestor->name ?></a></li>
        <?php endforeach; ?>
        <li>
            <span class="category-1"><?= $category->name ?></span>
        </li>
    </ol>
...
<div class="container">
    ...
    <div id="selector">
        <div class="spec-attr box">
            <h2><span class="red"><?= $category->name ?></span> 图书筛选</h2>
            <!--S 品牌-->
            <!--E 品牌-->
            <!--S 价格-->
