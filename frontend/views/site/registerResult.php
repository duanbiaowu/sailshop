...
<link rel="stylesheet" type="text/css" href="/themes/default/css/simple.css">
...
<div class="simple-box">
    ...
    <div class="blank">
        <p>
            <!--            您的昵称为：<b>774859743@163.com</b> 会展示在页面顶部和商品评价等地方，如不希望暴露，建议<b><a href="/index.php?con=ucenter&amp;act=info" class="red">修改昵称</a></b>,现在您可以尽情的购物了！-->
        </p>
    </div>
    <div class="blank tc">
        <a href="/" class="btn btn-gray">返回首页</a>
        <a href="/member/index" class="btn btn-main">用户中心</a>
    </div>
</div>
