            ...
            <div class="col-3">
                <div class="spec-info mt10 clearfix">
                    ...
                    <form action="" class="tiny-form hidden-msg" method="post" formmsg="field-info" novalidate="true">
                        ...
                        <?php if (isset($appraises[$book->isbn])): ?>
                        <h4 class="title">
                            您已完成评价
                        </h4>
                        <li class="line" style="margin-bottom: 0px;">
                            <input id="js-rate-input-<?= $index ?>" name="score[<?= $book->isbn ?>]" max="5" min="0" step="1" style="display:none" type="number" value="<?= $appraises[$book->isbn]->score ?>">
                        </li>
                        <li class="line textarea">
                            <label class="caption" style="height: auto;">
                                <?= $appraises[$book->isbn]->create_time ?> <br />
                                <?= $appraises[$book->isbn]->content ?>
                            </label>
                        </li>
                        ...
                        <?php if (count($appraises) != count($books)): ?>
