        ...
        <div class="container top-layout">
            ...
            <div class="sub-2">
                <ul class="nav-x">
                    ...
                    <?php else: ?>
                    <li class="item">你好, <?= Yii::$app->user->identity->username ?>!<a href="/site/logout"> 安全退出</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function updateCart(data) {
        if (data == null) {
            $.get("/site/test-cart", function (data) {
                if (data) {
                    updateInfo(data);
                }
            }, 'json');
    ...
    function updateInfo(data) {
        ...
        if (card_items == '') card_items = '<li> <div style="line-height:80px;text-align:center;">购物车中还没有图书，赶紧选购吧！</div> </li>';
