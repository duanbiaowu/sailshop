    ...
    <div id="widget_sub_navs"><div class="side-menu">
            ...
            <div class="sub-menu">
                ...
                <ul class="">
                    ...
                    <li class="menu-item <?php if (\Yii::$app->getRequest()->url === '/order/index'): ?>current<?php endif ?>">
                    ...
                    <li class="menu-item <?php if (\Yii::$app->getRequest()->url === '/member/browse/index'): ?>current<?php endif ?>">
                        <a href="/member/browse/index">退款申请<span class="l-triangle"></span></a>
                    </li>
                ...
                <ul class="">
                    ...
                    <li class="menu-item <?php if (\Yii::$app->getRequest()->url === '/member/password/index'): ?>current<?php endif ?>">
