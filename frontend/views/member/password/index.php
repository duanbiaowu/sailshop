        ...
        <div class="col-4">
            ...
            <table class="table table-list big">
                <tbody><tr class="even">
                    ...
                    <td width="120"><a href="/user/reset-password">修改</a></td>
                </tr>
                <tr class="odd">
                    <td class="caption"><i></i>邮箱验证</td>
                    <td>开启邮箱验证，更好的保护账户安全。</td>
                    <td><a class="btn btn-default" href="/index.php?con=ucenter&amp;act=activate_obj&amp;obj=email">验证邮箱</a></td>
                </tr>
                </tbody></table>
        </div>
    </div>
